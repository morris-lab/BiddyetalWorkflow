...
We can add additional information about each node in the data set. This could be any meta data about the cells in the data set, such as the cluster a cell belongs to.
